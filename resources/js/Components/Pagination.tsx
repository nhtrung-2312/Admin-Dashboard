    ...
    return (
        <div className="flex items-center justify-between border-t border-gray-200 bg-white px-4 py-3 sm:px-6">
            <div className="flex flex-1 justify-between sm:hidden">
                <Link
                    href={links[0].url || ''}
                    className={`relative inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 ${!links[0].url ? 'opacity-50 cursor-not-allowed' : ''}`}
                >
                    Trước
                </Link>
                <Link
                    href={links[links.length - 1].url || ''}
                    className={`relative ml-3 inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 ${!links[links.length - 1].url ? 'opacity-50 cursor-not-allowed' : ''}`}
                >
                    Sau
                </Link>
            </div>
