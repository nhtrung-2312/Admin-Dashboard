...
return [
    ...
    "system_delete_member_exist" => "Vẫn còn người dùng tại chức vụ này, kiểm tra lại trước khi xoá",

    "form_name" => "Tên Chức vụ",
    "form_name_placeholder" => "Nhập tên chức vụ",
    "form_permissions" => "Quyền hạn",
    "form_cancel" => "Hủy",
    "form_creating" => "Đang tạo...",
    "form_updating" => "Đang cập nhật...",
    "form_create" => "Tạo Chức vụ",
    "form_update" => "Cập nhật Chức vụ",
];