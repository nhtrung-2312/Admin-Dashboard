...
return [
    "head_title" => "Role Management",

    "list_title" => "Role List",
    "list_subtitle" => "Showing all the role",
    ...
    "system_delete_member_exist" => "There are still users in this role, please check before deleting",

    "form_name" => "Role Name",
    "form_name_placeholder" => "Enter role name",
    "form_permissions" => "Permissions",
    "form_cancel" => "Cancel",
    "form_creating" => "Creating...",
    "form_updating" => "Updating...",
    "form_create" => "Create Role",
    "form_update" => "Update Role",
];